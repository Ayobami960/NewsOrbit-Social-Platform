    ...
    <footer className="bg-ink-950 text-ink-300 mt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display font-bold text-xl text-white">
              News<span className="text-ember-500">Orbit</span>
            </span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            {[
              { href: "/about",   label: "About NewsOrbit" },
      ...
      <div className="border-t border-ink-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-ink-600 font-sans">© {new Date().getFullYear()} NewsOrbit. All rights reserved.</p>
